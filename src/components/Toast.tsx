...
export function AchievementToast({ id }: { id: AchievementId | null }) {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="anim-slidein pointer-events-none absolute right-0 top-14 z-40 flex w-[min(360px,calc(100%_-_1rem))] border-y border-l border-power/55 bg-deck/95 backdrop-blur"
    >
      ...
      <div className="min-w-0 flex-1 px-3 py-2.5">
        <div className="text-[9px] uppercase tracking-[0.24em] text-power/75">Directive complete</div>
